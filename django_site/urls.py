...
urlpatterns = [
    ...
    path('get_django_site_health/', views.get_django_site_health, name='get_django_site_health'),
...
handler404 = 'django_site.views.handler404'
handler500 = 'django_site.views.handler500'
