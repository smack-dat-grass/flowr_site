"""
Django settings for dope_deals_site project.
...
ROOT_URLCONF = 'dope_deals_site.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dope_deals_site.context_processors.load_base_variables',
            ],
        },
    },
]

WSGI_APPLICATION = 'dope_deals_site.wsgi.application'
