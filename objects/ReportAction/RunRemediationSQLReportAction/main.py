...
try:
    ...
    ora_conn.close_connection()
    create_alert(f'{report.name}',f"IAM Operations Dashboard was unable to run the remediation sql for {report.name} as a result of the following error: {str(e)}. This may require manual intervention")
